...
function ProductList({ onHomeClick }) {
    ...
    // Boolean, is product in the cart
    ...
    {/* Style for the amount of items in cart */ }
    const styleCart = {
        fill: 'white',
        fontSize: '80px'
    }
    ...
    return (
        <div>
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><h1 className='cart'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                            ...
                            {/* Quantity being shown in the cart */}
                            <text
                                x='130'
                                y='120'
                                textAnchor='middle'
            ...
            {/* Product cards from redux cart OR cart */}
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((category, index) => (
                        <div key={index}>
                            <h1>
                                <div className="category-centered">{category.category}</div>
                            </h1>
